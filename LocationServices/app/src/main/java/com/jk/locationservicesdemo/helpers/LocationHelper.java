...
//    public Location getLastLocation(Context context){
    public MutableLiveData<Location> getLastLocation(Context context){
        if (this.locationPermissionGranted){
            Log.e(TAG, "getLastLocation: Permission is granted...obtaining last location now");
...
//                                    Log.e(TAG, "onSuccess: Last location obtained Lat : " + myLocation.getLatitude() + " Lng : " + myLocation.getLongitude() );

                                    myLocation.setValue(location);
                                    Log.e(TAG, "onSuccess: Last location obtained Lat : " + myLocation.getValue().getLatitude() + " Lng : " + myLocation.getValue().getLongitude() );
                                }else{
...
//    public Location
    ...
    public void getLocationUpdates(Context context, LocationCallback locationCallback){
        if (locationPermissionGranted){
            try{
                ...
                Log.e(TAG, "getLocationUpdates: Exception occurred while receiving location updates" + ex.getLocalizedMessage() );
            }
        }else{
            Log.e(TAG, "getLocationUpdates: location permission not granted");
        }
    }
    ...
    public void stopLocationUpdates(Context context, LocationCallback locationCallback){
        try{
            ...
            Log.e(TAG, "stopLocationUpdates: Exception occurred while removing location updates" + ex.getLocalizedMessage() );
        }
    }
}
